...
public:
  ...
  void SetIntCount(int value)
  {
    time_intcount = value;
  }
  int GetIntCount(void)
  {
    return time_intcount;
  }
  int GetMasterCount(void)
  {
    return time_master;
  }
  int GetPassTick(void)
  {
    return pass_tick;
  }
  int GetAudioOutputMs(void)
  {
    return audio_output_ms;
  }
